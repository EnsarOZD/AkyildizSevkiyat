  ...
  <div class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
    <div class="bg-white dark:bg-gray-900 rounded-xl p-6 w-full max-w-md shadow-xl border-t-4 border-orange-500">
      ...
      <div class="space-y-4">
        ...
        <!-- API note -->
        <div class="flex items-start gap-2 bg-blue-50 dark:bg-blue-900/10 border border-blue-200 dark:border-blue-800 rounded-lg p-3">
          <svg class="h-4 w-4 text-blue-500 shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
            <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clip-rule="evenodd" />
          </svg>
          <p class="text-xs text-blue-700 dark:text-blue-400">
            Kargo API entegrasyonu hazır olduğunda irsaliye numarası, proje kodu, teslimat adresi ve alıcı bilgileri kargo firmasına otomatik iletilecektir.
          </p>
        </div>
      </div>
      ...
      <div class="mt-6 flex justify-end gap-3">
        ...
        <button
          @click="save"
          :disabled="selectedProvider === null || isSaving"
...
const save = async () => {
  if (selectedProvider.value === null || isSaving.value) return;
