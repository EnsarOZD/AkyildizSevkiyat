<template>
  <div v-if="needRefresh" class="fixed bottom-4 right-4 z-[9999] bg-white dark:bg-gray-800 p-4 rounded-xl shadow-2xl border border-gray-200 dark:border-gray-700 max-w-sm flex flex-col gap-3 animate-in slide-in-from-bottom-5">
    ...
    <div class="flex items-center gap-2 mt-1">
      <button @click="updateServiceWorker()" class="flex-1 bg-blue-600 text-white px-4 py-2.5 rounded-lg text-sm font-bold shadow-lg shadow-blue-200 dark:shadow-none hover:bg-blue-700 transition-colors">Yenile ve Güncelle</button>
