        ...
        <tbody class="bg-white dark:bg-gray-900 divide-y divide-gray-200 dark:divide-gray-700">
          <tr v-for="m in mappings" :key="m.id" class="hover:bg-gray-50 dark:hover:bg-gray-800">
            ...
            <td class="px-4 py-2 text-right text-sm">
              <button @click="openEdit(m)" class="text-blue-600 hover:text-blue-800 mr-3">Düzenle</button>
      ...
      <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div class="inline-block align-bottom bg-white dark:bg-gray-900 rounded-lg px-4 pt-5 pb-4 text-left shadow-xl transform sm:my-8 sm:align-middle sm:max-w-md sm:w-full sm:p-6">
          ...
          <div class="mt-5 sm:grid sm:grid-cols-2 sm:gap-3">
            <button @click="save" :disabled="saving" class="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-blue-600 text-base font-medium text-white hover:bg-blue-700 disabled:opacity-50 sm:col-start-2 sm:text-sm">
