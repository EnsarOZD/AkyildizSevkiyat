      ...
      <div class="flex flex-wrap gap-4 items-end">
        <div>
          ...
          <input type="date" v-model="filters.dateFrom"
            class="px-3 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500" />
        </div>
        <div>
        ...
        <div>
          ...
          <input type="text" v-model="projectSearch" placeholder="Proje adı veya kodu..."
            class="px-3 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500 w-52" />
        </div>
    ...
    <BaseModal :show="showCcModal" title="Mail Gönder — CC Seç" maxWidth="sm" @close="showCcModal = false">
      ...
      <template #footer>
        ...
        <button
          ...
          class="px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 font-semibold text-sm"
        >
          Gönder
        </button>
      </template>
...
function statusBadgeClass(s: string) {
  const m: Record<string, string> = {
    ...
    ReadyForDispatch: 'bg-blue-100 text-blue-700',
    AssignedToVehicle: 'bg-violet-100 text-violet-700',
